...
//                var_dump($data);exit;
		...
		if($n>0)
		{
                    ...
                    <div class="view">
                        ...
                        <!-- <a href="<?php echo Yii::app()->createUrl('information/view', array('id' => $value->id))?>"> -->
                        <div class="mydiv">
                            ...
                            <div class ="myphone">
                                <b><?php echo CHtml::encode($value->getAttributeLabel('phone')); ?>:</b>
                                <b><?php echo CHtml::encode($value->phone); ?></b>
                            </div>


                                <div class="myprice">
                                <b><?php echo CHtml::encode($value->getAttributeLabel('price')); ?>:</b>
                                <b><?php echo CHtml::encode($value->price); ?> Դրամ</b>
                                </div>		
                                <div class="mydate">
                                <b><?php echo CHtml::encode($value->getAttributeLabel('time')); ?>:</b>
                                <b><?php echo CHtml::encode($value->time); ?></b>
                                </div>
